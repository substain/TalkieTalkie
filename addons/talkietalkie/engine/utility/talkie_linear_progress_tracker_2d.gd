class_name TalkieLinearProgressTracker2D extends Area2D
...
@export var slide_target: TalkieSlide
...
func _physics_process(_delta: float) -> void:
	...
	TalkieSlideHelper.slide_controller.set_slide_progress(slide_index, current_progress)
