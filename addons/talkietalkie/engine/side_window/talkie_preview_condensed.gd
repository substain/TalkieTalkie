class_name TalkiePreviewCondensed
extends Control

const _TEX_EYE: Texture2D = preload("uid://cd1pjw2q6fjmh") #/style/ui/eye.svg
const _TEX_EYE_HOVER: Texture2D = preload("uid://b21tjxv25abxe") #/style/ui/eye_hover.svg
const _TEX_EYE_PRESSED: Texture2D = preload("uid://bvfk64gc8bu7u") #/style/ui/eye_pressed.svg
const _TEX_EYE_CROSSED: Texture2D = preload("uid://crb2ialujm6bp") #/style/ui/eye_crossed.svg
const _TEX_EYE_CROSSED_HOVER = preload("uid://brrj2lmlu2go5") #/style/ui/eye_crossed_hover.svg
const _TEX_EYE_CROSSED_PRESSED = preload("uid://ba7qnkbw1i8pa") #/style/ui/eye_crossed_pressed.svg

signal toggle_preview_visible(is_visible_new: bool)
signal toggle_preview_on_top(is_on_top_new: bool)

@export var target_slide_preview: TalkieSlidePreview
...
func set_preview_visible(is_visible_new: bool, update_button: bool = false) -> void:
	...
	popup_button.texture_normal = _TEX_EYE if is_visible_new else _TEX_EYE_CROSSED
	popup_button.texture_pressed = _TEX_EYE_PRESSED if is_visible_new else _TEX_EYE_CROSSED_PRESSED
	popup_button.texture_hover = _TEX_EYE_HOVER if is_visible_new else _TEX_EYE_CROSSED_HOVER
