...
@export var side_window_ui: TalkieSideWindowUI
...
func save_side_window_layout_settings() -> void:
	...
	TalkiePreferences.set_side_window_layout_settings(side_window_layout_settings)
...
func load_side_window_layout_settings() -> void:
	if TalkiePreferences.side_window_layout_settings == null:
		...
		side_window_layout_settings = TalkiePreferences.side_window_layout_settings
...
func _on_preview_layout_settings_updated(rel_index: int, preview_layout_settings: TalkiePreviewLayoutSettings) -> void:
