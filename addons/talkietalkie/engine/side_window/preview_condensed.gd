...
static var TEX_EYE: Texture2D = load(TTSetup.get_plugin_path() + "/style/ui/eye.svg")
static var TEX_EYE_HOVER: Texture2D = load(TTSetup.get_plugin_path() + "/style/ui/eye_hover.svg")
static var TEX_EYE_PRESSED: Texture2D = load(TTSetup.get_plugin_path() + "/style/ui/eye_pressed.svg")

static var TEX_EYE_CROSSED: Texture2D = load(TTSetup.get_plugin_path() + "/style/ui/eye_crossed.svg")
static var TEX_EYE_CROSSED_HOVER: Texture2D = load(TTSetup.get_plugin_path() + "/style/ui/eye_crossed_hover.svg")
static var TEX_EYE_CROSSED_PRESSED: Texture2D = load(TTSetup.get_plugin_path() + "/style/ui/eye_crossed_pressed.svg")
