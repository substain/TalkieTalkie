class_name TalkieUI extends CanvasLayer
...
@export var control_bar: TalkieControlBar
@export var tab_navigation_bar: TalkieTabNavigationBar
...
func _ready() -> void:
	TalkieSlideHelper.ui = self
	
	control_bar.visible = ProjectSettings.get_setting("talkietalkie/ui/enable_control_bar", true) as bool
	tab_navigation_bar.visible = ProjectSettings.get_setting("talkietalkie/ui/enable_tabnav_bar", true) as bool
	settings.visible = ProjectSettings.get_setting("talkietalkie/ui/enable_settings", true) as bool

	settings.update_ui_button_position(get_show_toggle_ui_button_bool(), _toggle_ui_button)
	
	set_ui_visible(get_open_ui_on_startup_bool(), true)
...
static func get_open_ui_on_startup_bool() -> bool:
	return TalkiePreferencesClass.is_str_as_system_conditional_true(ProjectSettings.get_setting("talkietalkie/ui/open_ui_on_startup", "on_mobile") as String)
	
static func get_show_toggle_ui_button_bool() -> bool:
	return TalkiePreferencesClass.is_str_as_system_conditional_true(ProjectSettings.get_setting("talkietalkie/ui/show_toggle_ui_button", "on_mobile") as String)
