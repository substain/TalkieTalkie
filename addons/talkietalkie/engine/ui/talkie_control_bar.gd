class_name TalkieControlBar extends HidableUI
...
func _ready() -> void:
	super()
	_quit_button.visible = !TalkieUtil.is_web()
	set_fullscreen_active(TalkiePreferences.fullscreen_active, false)
...
func set_fullscreen_active(is_active_new: bool, do_save: bool = true) -> void:
	...
	TalkiePreferencesClass.set_fullscreen(is_active_new)
	TalkiePreferences.set_fullscreen_active(is_active_new, true)
