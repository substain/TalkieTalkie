class_name TalkieSlide2DLineMapper
extends Node2D
...
func _ready() -> void:
	...
	if TalkieSlideHelper.get_context() != null:
		...
		TalkieSlideHelper.context_initialized.connect(map_slides_to_2d)
...
func map_slides_to_2d() -> void:
	...
	var slide_center_locations: Dictionary[Vector2, TalkieSlide] = {}
