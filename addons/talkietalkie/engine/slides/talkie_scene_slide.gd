class_name TalkieSceneSlide extends TalkieSlide
...
@export var in_transition_override: TalkieTransition = null
...
# override
func get_in_transition_override() -> TalkieTransition:
	return in_transition_override

# override	
func set_in_transition_override(new_in_transition_override: TalkieTransition) -> void:
