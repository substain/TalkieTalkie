...
const _DEFAULT_TRANSITION_2D: Resource = preload("uid://dk3t4yybco1lu") #/engine/transitions/move_transition_2d.gd
const _DEFAULT_TRANSITION_3D: Resource = preload("uid://bchabe2odsgl6") #/engine/transitions/move_transition_3d.gd
