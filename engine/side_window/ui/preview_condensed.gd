...
const TEX_EYE: Texture2D = preload("res://style/ui/eye.svg")
const TEX_EYE_HOVER: Texture2D = preload("res://style/ui/eye_hover.svg")
const TEX_EYE_PRESSED: Texture2D = preload("res://style/ui/eye_pressed.svg")

const TEX_EYE_CROSSED: Texture2D = preload("res://style/ui/eye_crossed.svg")
const TEX_EYE_CROSSED_HOVER: Texture2D = preload("res://style/ui/eye_crossed_hover.svg")
const TEX_EYE_CROSSED_PRESSED: Texture2D = preload("res://style/ui/eye_crossed_pressed.svg")
