...
## Also initializes the 3D context for the SlideHelper autoload, which is used for 3D transition.
...
func map_slides_to_2d() -> void:
	var slide_context: SlideContext3D = SlideHelper.get_context_3d()
